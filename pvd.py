...
pasta = "D:/Documentos/Permanent-heat-conduction/Petrov-Galerkin-Method/DataPGLS"
arquivos = sorted(glob(os.path.join(pasta, "results_t=*.vtu")))

# Nome do arquivo de saída .pvd
saida_pvd = os.path.join(pasta, "results.pvd")
...
with open(saida_pvd, "w") as f:
    ...
    for arq in arquivos:
        ...
        tempo = nome.replace("results_t=", "").replace(".vtu", "")
