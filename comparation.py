...
freefem_y, freefem_u1 = np.loadtxt("D:/Documentos/Permanent-heat-conduction/Square_Data/perfil_u1_x05_Re100.txt", unpack=True)
# v ao longo de x no centro horizontal (y = 0.5)
freefem_x, freefem_u2 = np.loadtxt("D:/Documentos/Permanent-heat-conduction/Square_Data/perfil_u2_y05_Re100.txt", unpack=True)
...
plt.title('Perfil u1(x=0.5) Re=100, t=20s', fontsize=30)
...
plt.title('Perfil u2(y=0.5) Re=100, t=20s', fontsize=30)
plt.legend(loc='lower right', fontsize=20)
plt.grid(True)
plt.tight_layout()
